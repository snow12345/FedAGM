def build_local_update_module(args):
    ...
    elif args.method == 'KD_proto_generator':
        from local_update_method.KD_proto_generator import LocalUpdate
    ...
    elif args.method == 'FedNAG_EWC':
        from local_update_method.fed_NAG_EWC import LocalUpdate
