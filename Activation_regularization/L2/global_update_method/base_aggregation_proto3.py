...
def GlobalUpdate(args,device,trainset,testloader,LocalUpdate):
    ...
    model_double_delta=copy.deepcopy(model)
    ...
    for epoch in range(args.global_epochs):
        ...
        if epoch==0:
            ...
            idea_img=filter_visualize(model_double_delta,device,size=1)
        ...
        for key in FedAvg_weight.keys():
            ...
            double_delta[key]=2*FedAvg_weight[key]-double_delta[key]
        model.load_state_dict(FedAvg_weight)
        model_double_delta.load_state_dict(double_delta)
