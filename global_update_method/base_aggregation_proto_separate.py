...
def GlobalUpdate(args,device,trainset,testloader,LocalUpdate):
    ...
    this_alpha_proto = args.alpha_proto
    ...
    for epoch in range(args.global_epochs):
        ...
        for user in selected_user:
            ...
            local_setting = LocalUpdate(args=args, lr=this_lr, local_epoch=args.local_epochs, device=device,
                                        batch_size=args.batch_size, dataset=trainset, idxs=dataset[user], alpha=this_alpha,alpha_proto=this_alpha_proto)
        ...
        if args.alpha_proto_mul_epoch == True:
            this_alpha_proto = args.alpha_proto * (epoch + 1)
        elif args.alpha_proto_divide_epoch == True:
            this_alpha_proto = args.alpha_proto / (epoch + 1)            
